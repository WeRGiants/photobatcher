...
# Safety: prevent extreme images from blowing memory
...
# =====================================================
# SMART CROP (WHITESPACE TRIM + PADDING)
# =====================================================
...
# =====================================================
# ENHANCEMENT (EXPORT vs PREVIEW)
# =====================================================

def enhance_export(image: Image.Image) -> Image.Image:
    """Subtle, marketplace-safe enhancement."""
...
def enhance_preview(image: Image.Image) -> Image.Image:
    """Stronger preview enhancement to create 'wow' factor."""
...
async def preview_image(file: UploadFile = File(...)):
    ...
    try:
        with Image.open(BytesIO(data)) as img:
            ...
            return StreamingResponse(out, media_type="image/jpeg", headers={"Cache-Control": "no-store"})
    except Exception:
